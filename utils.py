...
def load_dataset(input_dir="data/input", repository="gdsc", drug_id=-1, random_seed=2019, shuffle_feature=False):
...
def load_dataset_autoencoder(input_dir="data/input", repository="gdsc", random_seed=2019, omic="exp"):
    """ Load dataset. Samples will be shuffled and all omics data and sensitivity
    data will be in the same order of samples.
    ...
    random.Random(random_seed).shuffle(rng)
